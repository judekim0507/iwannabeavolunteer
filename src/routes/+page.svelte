    ...
    onMount(() => {
        ...
        (async () => {
            ...
            if (
                (!destinationId ||
                    !councils.some(
                        (council) => council.id === destinationId,
                    )) &&
                councils.length > 0
            ) {
    ...
    <div class="mx-auto max-w-sm">
        {#if loading}
            <div class="space-y-8 animate-pulse">
                <div class="flex items-center gap-4">
                    ...
                    <div
                        class="h-[14px] flex-1 bg-neutral-200 rounded-full"
                    ></div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div
                        class="h-16 w-full bg-neutral-200 rounded-[73px]"
                    ></div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-2">
                        <div
                            class="h-16 flex-1 bg-neutral-200 rounded-[73px]"
                        ></div>
                        <div
                            class="h-16 flex-1 bg-neutral-200 rounded-[73px]"
                        ></div>
        ...
        {:else}
            ...
            >
                {#if error}
                    <div
                        class="rounded-xl border-[3px] border-red-400 bg-red-50 p-4"
                    >
                ...
                {:else}
                    ...
                    {#if activeEvent?.ends_at}
                        <div class="flex items-center gap-3">
                            ...
                            <div class="inline-grid leading-none flex-1">
                                <div
                                    class="bg-[#f2f2f2] h-[14px] w-full rounded-[36px]"
                                ></div>
                                <div
                    ...
                    {#if submitted}
                        ...
                        >
                            ...
                            <h2
                                class="font-['Nunito'] font-black text-[28px] text-[#333]"
                            >
                                You're in!
                            </h2>
                    ...
                    {:else if isExpired}
                        ...
                        >
                            ...
                            <p class="font-['Inter'] text-[16px] text-[#666]">
                                This event has ended. Check back later for new
                                opportunities!
                            </p>
                        </div>
                    {:else if !activeEvent}
                        ...
                        >
                            ...
                            <h2
                                class="font-['Nunito'] font-black text-[24px] text-[#333]"
                            >
                                No active event yet
                            </h2>
                            <p class="font-['Inter'] text-[16px] text-[#666]">
